		...
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `guest` NATURAL JOIN `room` WHERE `status` = 'Check Out'") or die(mysqli_connect_error());
						...
						<tr>
							...
							<td><?php echo "<label>".date("d M, Y", strtotime($fetch['checkin']))."</label>"." TIME: "."<label>".date("h:i a", strtotime($fetch['checkin_time']))."</label>"?></td>
							<td><?php echo $fetch['days']?></td>
							<td><?php echo "<label>".date("d M, Y", strtotime($fetch['checkin']."+".$fetch['days']."DAYS"))."</label>"." TIME: "."<label>".date("h:i A", strtotime($fetch['checkout_time']))."</label>"?></td>
